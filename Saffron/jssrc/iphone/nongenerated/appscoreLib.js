...
appscore.alert = {
        ...
        confirm: function(titleKey, msgKey, callBack) {
            kony.ui.Alert({
                message: appscore.app.getString(msgKey),
                alertType: constants.ALERT_TYPE_CONFIRMATION,
                alertTitle: appscore.app.getString(titleKey),
                yesLabel: appscore.app.getString("YES"),
                noLabel: appscore.app.getString("NO"),
        ...
        confirmWithCustomLabel: function(titleKey, msgKey, callBack, yesLabelKey, noLabelKey) {
            kony.ui.Alert({
                ...
                alertType: constants.ALERT_TYPE_CONFIRMATION,
                alertTitle: appscore.app.getString(titleKey),
                yesLabel: appscore.app.getString(yesLabelKey),
                noLabel: appscore.app.getString(noLabelKey),
                alertHandler: callBack
            }, {});
        },
        /**
        ...
        info: function(titleKey, msgKey, callBack) {
            kony.ui.Alert({
                ...
                alertTitle: appscore.app.getString(titleKey),
                yesLabel: appscore.app.getString("OK"),
                noLabel: appscore.app.getString("Cancel"),
                alertHandler: callBack
            }, {});
        },
        /**
...
appscore.dao = {
     ...
     * @param  {String} key access key of the object to store
     * @param  {Object} obj	An Object to store in the kony storage
     */
     ...
     * @param  {String} key access key of the object to remove    
     */
    remove: function(key) {
