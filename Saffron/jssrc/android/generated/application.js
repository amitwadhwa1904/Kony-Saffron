...
_invokeServiceAsyncForMF_ = function(url, inputParam, callBack) {
    ...
    if (!operationID) {
        ...
        var _mfServicesMap_ = {
            "ConcurrenceTest": {
                "servicename": "Concurrencetest",
                "serviceid": "30851d5e-b897-46a5-8cd1-c3269bcf708e",
                "type": "orchestration",
                "operationname": "ConcurrenceTest",
                "operationid": "2238"
            },
            "NewOperation": {
                "servicename": "GetDVDMovies",
                "serviceid": "21a4ec42-dbc1-461c-ad13-44bb8235b33b",
                "type": "integration",
            ...
            "getArticles": {
                "servicename": "FoxNews",
                "serviceid": "e177674d-765b-4728-964c-e409ae45e98a",
                "type": "integration",
                "operationname": "getArticles",
                "operationid": "2140"
            },
            "GetCityForecastByZIP": {
                "servicename": "USWeather",
                "serviceid": "b989a3ce-8a8c-4475-8e26-6fcda39d4e2c",
                "type": "integration",
                "operationname": "GetCityForecastByZIP",
                "operationid": "2207"
            },
            "getMap": {
                "servicename": "JSONtesting",
                "serviceid": "b8928f01-d66c-4a03-a701-238b852cfe2c",
                "type": "integration",
                "operationname": "getMap",
                "operationid": "2210"
            },
            "GetCityNameFromGPS": {
                "servicename": "GetCityFromGPS",
                "serviceid": "0bfefd46-e1a0-4211-8a3f-ab70c1f11129",
                "type": "integration",
                "operationname": "GetCityNameFromGPS",
                "operationid": "2243"
            },
            "GetStoreInfo": {
                "servicename": "GetStoreInCity",
                "serviceid": "263cbcba-d600-4ee5-9839-eb7877515511",
                "type": "integration",
                "operationname": "GetStoreInfo",
                "operationid": "2246"
            },
            "getStoreInfo": {
                "servicename": "GetStoreInCityForPostprocessor",
                "serviceid": "c278a327-be26-4a29-840d-6fab93b53441",
                "type": "integration",
                "operationname": "getStoreInfo",
                "operationid": "2257"
            }
